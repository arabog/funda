...
componentDidMount() lifecycle method. Inside it, the Clock 
...
object containing the current time. Thanks to the setState() call, React 
...
render() method will be different, and so the render output will include 
the updated time. React updates the DOM accordingly.

5. If the Clock component is ever removed from the DOM, React 
calls the componentWillUnmount() lifecycle method so the timer is 
stopped.
