...
“render props” you don’t have to use a prop named render to use 
this pattern. In fact, any prop that is a function that a component 
uses to know what to render is technically a “render prop”.

Although the examples above use render, we could just as easily 
...
And remember, the children prop doesn’t actually need to be named 
in the list of “attributes” in your JSX element. Instead, you can put 
it directly inside the element!
...
function MouseTracker() {
          // Defined as an instance fxn, `renderTheCat` always
...
const Mouse = (props) => {
          ...
          return (
                    <div style={{height: '100vh', width: '100vw', overflow: 'hidden'}} onMouseMove={handleMouseMove}>
                              <p>The current mouse position is ({xAxis}, {yAxis})</p>
