...
Now, let's make things a bit more complex. We want to create 
a new component that only displays a button. Once we click 
on it, our page title will change depending on the page we're 
currently on; we can always roll back to the original title by 
clicking on the button again.
Let's create a new folder, components/ , in your project root 
and a new file, components/Widget.js , inside it:
